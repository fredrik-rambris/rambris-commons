...
public class Util
{
	 ...
	 * @throws IOException
	 */
	public static long CountFileRows(File path) throws IOException
	{
		BufferedReader in=null;
		try
		{
			in=new BufferedReader(new InputStreamReader(GZip.OpenGZipFile(path)));
			long rows=0;
			while(in.readLine()!=null) rows++;
			return rows;
		}
		finally
		{
